      ...
      <header className={theme}>
        <div className="content">
          <Link to="/" className="logo-link">
            <svg width="94.19" height="45" viewBox="0 0 157 75" fill="none" xmlns="http://www.w3.org/2000/svg" className={theme}>
          ...
          <div>
            <RoomCode theme={theme} code={roomId}/>
          ...
          <div className="form-footer">
            { user ? (
              ...
              <span>
                ...
                <button className="create-room" onClick={signInWithGoogle} type="button">
