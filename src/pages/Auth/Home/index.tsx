...
import lightThemeImg from '../../../assets/images/light-theme.svg'
...
export function Home() {
  ...
  async function handleJoinRoom(event: FormEvent) {
    ...
    if (roomCode.trim() === '') {
      if (theme === 'dark') {
        toast.error("Você precisa digitar o código da sala antes de clicar para entrar.", {
            style: {
              background: '#333',
              color: '#fff',
            },
